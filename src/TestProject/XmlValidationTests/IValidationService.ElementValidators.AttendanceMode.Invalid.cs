...
namespace TestProject.XmlValidationTests
{
        ...
        where T : XCRI.Validation.IValidationService<String>
    {
        ...
        [TestMethod]
        public void Invalid_AttendanceMode_WithoutIdentifier()
        {
            ...
            var vr = elementValidator
                .Validate(System.Xml.Linq.XDocument.Parse(Resources.IValidationService.Invalid.ElementValidation.AttendanceMode.WithoutIdentifier).Root)
