...
namespace TestProject.XmlValidationTests
{
        ...
        where T : XCRI.Validation.IValidationService
    {
        ...
        public void Invalid_Formatting_GeneratedAttribute()
        {
            ...
            var results = t.Validate<Uri>(new Uri(new System.IO.FileInfo(@"IValidationService\Invalid\Formatting\GeneratedAttribute.xml").FullName));
        ...
        public void Invalid_Namespaces_UndeclaredPrefix()
        {
            ...
            var t = base.Instantiate();
            t.XmlExceptionInterpreters.Add(interpreter);
            var results = t.Validate<Uri>(new Uri(new System.IO.FileInfo(@"IValidationService\Invalid\Namespaces\UndeclaredPrefix.xml").FullName));
            Assert.AreEqual<int>(1, results.Count, "1 exception expected");
        }
        ...
        public void Invalid_Namespaces_NoDocumentNamespace()
        {
            ...
            var t = base.Instantiate();
            t.XmlExceptionInterpreters.Add(interpreter);
            var results = t.Validate<Uri>(new Uri(new System.IO.FileInfo(@"IValidationService\Invalid\Namespaces\NoDocumentNamespace.xml").FullName));
            Assert.AreEqual<int>(1, results.Count, "1 exception expected");
        }
        ...
        public void Invalid_Namespaces_Description()
        {
            ...
            var t = base.Instantiate();
            t.XmlExceptionInterpreters.Add(interpreter);
            var results = t.Validate<Uri>(new Uri(new System.IO.FileInfo(@"IValidationService\Invalid\Namespaces\Description.xml").FullName));
            Assert.AreEqual<int>(1, results.Count, "1 exception expected");
        }
        ...
        public void Invalid_Namespaces_Title()
        {
            ...
            var t = base.Instantiate();
            t.XmlExceptionInterpreters.Add(interpreter);
            var results = t.Validate<Uri>(new Uri(new System.IO.FileInfo(@"IValidationService\Invalid\Namespaces\Title.xml").FullName));
            Assert.AreEqual<int>(1, results.Count, "1 exception expected");
        }
        ...
        public void Invalid_Namespaces_Identifier()
        {
            ...
            var t = base.Instantiate();
            t.XmlExceptionInterpreters.Add(interpreter);
            var results = t.Validate<Uri>(new Uri(new System.IO.FileInfo(@"IValidationService\Invalid\Namespaces\Identifier.xml").FullName));
            Assert.AreEqual<int>(1, results.Count, "1 exception expected");
        }
        ...
        public void Invalid_Structure_XmlNesting()
        {
            ...
            var t = base.Instantiate();
            t.XmlExceptionInterpreters.Add(interpreter);
            var results = t.Validate<Uri>(new Uri(new System.IO.FileInfo(@"IValidationService\Invalid\Structure\XmlNesting.xml").FullName));
            Assert.AreEqual<int>(1, results.Count, "1 exception expected");
